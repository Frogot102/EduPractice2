...
namespace EduPractice2.ViewModels
{
    public partial class CustomerWindowViewModel : ViewModelBase
    {
        ...
        public CustomerWindowViewModel(User user, Role role, DatabaseService dbService, MainWindowViewModel mainWindowViewModel)
            : base(user, role, dbService)
        {
            ...
            WelcomeMessage = $"Личный кабинет заказчика: {user.FullName ?? user.Login}";
