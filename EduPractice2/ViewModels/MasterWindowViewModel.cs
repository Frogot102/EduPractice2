...
{
    public partial class MasterWindowViewModel : ViewModelBase
    {
        ...
        public MasterWindowViewModel(User user, Role role, DatabaseService dbService, MainWindowViewModel mainWindowViewModel)
            : base(user, role, dbService)
        {
            ...
            WelcomeMessage = $"Панель мастера: {user.FullName ?? user.Login}";
