...
{
    public partial class DesignerWindowViewModel : ViewModelBase
    {
        ...
        public DesignerWindowViewModel(User user, Role role, DatabaseService dbService, MainWindowViewModel mainWindowViewModel)
            : base(user, role, dbService)
        {
            ...
            WelcomeMessage = $"Панель конструктора: {user.FullName ?? user.Login}";
